...
class GetAssistantDetailsUseCase(private val repository: AssistantsRepository, private val assistantId: String) {
    suspend operator fun invoke(): MockResponse = repository.getAssistantDetails(assistantId)
}

class DeleteAssistantUseCase(private val repository: AssistantsRepository, private val assistantId: String) {
