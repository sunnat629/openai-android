...
class GetFileDetailsUseCase(private val repository: FilesRepository, private val fileId: String) {
    suspend operator fun invoke(): MockResponse = repository.getFileDetails(fileId)
}

class DeleteFileUseCase(private val repository: FilesRepository, private val fileId: String) {
    suspend operator fun invoke(): MockResponse = repository.deleteFile(fileId)
}

class GetFileContentUseCase(private val repository: FilesRepository, private val fileId: String) {
