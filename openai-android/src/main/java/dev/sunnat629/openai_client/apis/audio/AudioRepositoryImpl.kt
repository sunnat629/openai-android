...
class AudioRepositoryImpl(private val client: HttpClient) : AudioRepository {
    ...
    override suspend fun createTranscription(model: String, byteArray: ByteArray): TranscriptionResponse {
    ...
    override suspend fun createTranslation(request: CreateTranslationRequest): TranslationResponse {
