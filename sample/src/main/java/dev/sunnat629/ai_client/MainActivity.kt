...
import dev.sunnat629.ai_client.models.audio.TTSModel
import dev.sunnat629.ai_client.models.audio.Voice
import dev.sunnat629.ai_client.ui.theme.OpenAiAndroidTheme
...
//                                .timestampGranularities(TimestampGranularity.WORD)
    ...
    fun MySendMessageUI(audioUrl: MutableState<Uri?>) {
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Row {
                Button(onClick = { pickAudioLauncher.launch(arrayOf("*/*")) }) {
